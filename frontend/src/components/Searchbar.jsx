...
const SearchBar = () => {
  ...
  return (
    <div className="w-full relative" ref={dropdownRef}>
      <div
        className={`flex items-center primary rounded-lg transition-all duration-300 p-3 overflow-hidden`}
      >
      ...
      {query.length > 1 && (
        <div
          className={`absolute left-0 right-0 mt-2 primary border-gray-800 rounded-lg shadow-lg max-h-80 overflow-y-auto z-[99999] ${
