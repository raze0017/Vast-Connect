  ...
  return (
    ...
    >
      {loading ? (
        ...
        <>
          <div className="user-preview flex items-center justify-between space-x-4 p-4 primary rounded-lg">
            <div
            ...
            >
              ...
              />
              <h2 className="text-xl text-primary hover:underline">
                @{user?.username}
              </h2>
            </div>
            {userId !== loggedInUserId && (
              <button
                ...
                className={`py-2 px-4 rounded-md font-semibold flex items-center ${
                  followed ? "bg-gray-700 text-primary" : "neutral text-primary"
                }`}
              >
                <FontAwesomeIcon
          ...
          {hovered && (
            <div className="absolute z-10 p-4 secondary border border-gray-700 rounded-lg shadow-lg mt-2 w-64">
